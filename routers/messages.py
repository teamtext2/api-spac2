        ...
        for peer in all_peers:
            ...
            if is_group:
                ...
                conversations.append({
                    ...
                    "avatar": ginfo.get("avatar") or "https://text2.co/favicon.ico",
                    "status": "online",
                    "last_seen": None,
                ...
                conversations.append({
                    ...
                    "avatar": uinfo.get("avatar") or "https://text2.co/favicon.ico",
                    "status": "online" if is_online else (uinfo.get("status") or "offline"),
                    "last_seen": uinfo.get("last_seen"),
                    "bio": uinfo.get("bio") or "Hey there! I am using Text2Chat.",
                    "isGroup": False,
                    "isSavedMessages": False,
                    "lastMessage": formatted_lmsg,
                    "timestamp": ts,
    ...
    try:
        ...
        for msg in messages:
            ...
            msg_payload = {
                ...
                "senderAvatar": sender_avatars.get(sender_id, "https://text2.co/favicon.ico"),
    ...
    try:
        ...
        for msg in messages:
            ...
            formatted_messages.append({
                ...
                "reactions": reactions_dict,
                "delivered": True if msg["recipient"] == username else msg["delivered"],
                "senderAvatar": sender_avatars.get(msg["sender"].strip().lower(), "https://text2.co/favicon.ico"),
                "replyTo": msg.get("reply_to"),
                "forwardedFrom": msg.get("forwarded_from"),
                "forwarded": True if msg.get("forwarded_from") else False
            })
